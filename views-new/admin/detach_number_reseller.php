...
<div class="row">
	...
	<div class="col-sm-10">
		<h3>Assigned clds to reseller</h3><br>
		<?php Pjax::begin(['id' => 'pjax_cld_assigned']) ?>

		<?php $form = ActiveForm::begin(['method' => 'get','action' => ['show-assigned-reseller']]); ?>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?php
				$form = ActiveForm::begin(['id' => 'detachForm','method'=>'post','action' => ['admin/detach-number-reseller']]);
				?>
