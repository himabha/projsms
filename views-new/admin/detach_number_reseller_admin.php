...
<div class="row">
	...
	<div class="col-sm-10">
		<h3>Assigned CLDs to Reseller Admin</h3><br>
		<?php Pjax::begin(['id' => 'pjax_cld_assigned']) ?>

		<?php $form = ActiveForm::begin(['method' => 'get','action' => ['show-assigned-reseller-admin']]); ?>

		<div class="row filter_outer">
			<div class="col-sm-3">
				<?= Html::dropDownList('admin_id',$resellerAdminId,$resellerAdmins,['id' => 'admin_id','prompt' => '---select---' ,'class' => 'form-control']); ?>
			</div>
			<div class="col-sm-3">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?php
				$form = ActiveForm::begin(['id' => 'detachForm','method'=>'post','action' => ['admin/detach-number-reseller-admin']]);
				?>
