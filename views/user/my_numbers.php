				...
				<div class="card">
					...
					<div class="card-body">
						<div>
							<ul class="gv_top">
								<li>
									<?= Html::a('Allocate Number to Agent', ['assign-cld'], ['class' => 'btn btn-success pull-left']) ?>
								</li>
								<li>
									<?= Html::a('Detach Number from Agent', ['show-assigned'], ['class' => 'btn btn-success pull-left']) ?>
								</li>
								<li>
