...
$this->registerJs('
	...
	function doSearch() {
		...
		params.append("TdrSearchSummary[reseller_id]", document.getElementById("dd_reseller_id").value);
					...
					<div class="card-body">
						...
						<div id="dropdown_top" style="margin-top:1em;">
							<ul class="gv_top">
								...
								<li>
									<?= Html::dropdownlist('dd_reseller_id',  isset($_GET['TdrSearchSummary']['reseller_id']) ?  $_GET['TdrSearchSummary']['reseller_id'] : "", $resellers, ['id' => 'dd_reseller_id', 'class' => 'btn btn-dark btn-sm', 'prompt' => 'Select Client']); ?>
								</li>
								<li>
							...
							<?= GridView::widget([
								...
								'columns' => [
									...
									[
										...
										'attribute' => 'admin_id',
										'value' => function ($model) {
											return $model->resellers ? $model->resellers->username : null;
										}
									],
									[
										'attribute' => 'msgs',
