			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title ">Calls Detailed Report</h4>
					</div>
					<div class="card-body">
							...
							<?= GridView::widget([
								...
								'columns' => [
									...
									[
										...
										'attribute' => 'Cost',
										'footer' => '<strong>Total Cost: $' . Fsmycdr::getTotalCost($dataProvider->models) . '</strong>',
									],
									[
										'header' => '<a href="#">Sale</a>',
										'attribute' => 'Sale',
										'footer' => '<strong>Total Sale : $' . Fsmycdr::getTotalSale($dataProvider->models) . '</strong>',
									],
									/*					[
