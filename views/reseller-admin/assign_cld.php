	...
	<div class="container-fluid">
		<div class="card ">
			<div class="card-header card-header-primary card-header-icon">
				...
				<h4 class="card-title">
					<span>Assign CLD to Reseller</span>
			...
			<div class="card-body">
				...
				<a href="<?= Url::toRoute(['reseller-admin/add-cld']) ?>" class="btn btn-default pull-right">Back</a>
...
<script type="text/javascript">
	$(document).on('click', '#assign_nmbr', function() {
		...
		if (flag) {
			...
			$.ajax({
				url: baseurl + '?r=reseller-admin/assign-number',
				type: 'post',
				data: {
					user: user,
					numbers: strvalue
