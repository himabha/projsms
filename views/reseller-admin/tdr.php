                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="dropdown_top">
                            <ul class="gv_top">
                                <li>
                                    <?= Html::dropdownlist('dd_reseller_id',  isset($_GET['TdrSearch']['reseller_id']) ?  $_GET['TdrSearch']['reseller_id'] : ""  , $resellers, ['id' => 'dd_reseller_id', 'class' => 'btn-dark btn-sm', 'prompt' => 'Select Reseller']); ?>
                                </li>
                            </ul>
                        </div>
                        <div>
