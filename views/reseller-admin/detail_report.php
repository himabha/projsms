                    ...
                    <div class="card-body">
                        ...
                        <div id="dropdown_top" style="margin-top:1em;">
                            <ul class="gv_top">
                                ...
                                <li>
                                    <?= Html::dropdownlist('dd_reseller_id',  isset($_GET['TdrSearchSummary']['reseller_id']) ?  $_GET['TdrSearchSummary']['reseller_id'] : ""  , $resellers, ['id' => 'dd_reseller_id', 'class' => 'btn btn-dark btn-sm', 'prompt' => 'Select Reseller']); ?>
                                </li>
                                <li>
