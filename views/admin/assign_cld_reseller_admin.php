			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title ">Assign CLD to reseller admin</h4>
					</div>
					<div class="card-body">
						...
						<div id="user_nam_outr" class="form-group">
							<label class="control-label">Reseller Admin</label>
						...
						<a href="<?= Url::toRoute(['admin/add-cld-reseller-admin']) ?>" class="btn btn-default pull-right">Back</a>
						<div class="grid_holdr">
							<?php $form = ActiveForm::begin(['method' => 'get', 'action' => ['assign-cld-reseller-admin']]); ?>
							<div class="row">
								<div class="col-sm-5">
...
<script type="text/javascript">
	$(document).on('click', '#assign_nmbr', function() {
		...
		if (flag) {
			...
			$.ajax({
				url: baseurl + '?r=admin/assign-number-reseller-admin',
				type: 'post',
				data: {
					user: user,
					numbers: strvalue
