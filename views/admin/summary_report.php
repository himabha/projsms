...
$this->registerJs('
	...
	function doSearch() {
		...
		params.append("TdrSearchSummary[admin_id]", document.getElementById("dd_admin_id").value);
		params.append("TdrSearchSummary[sender_id]", document.getElementById("dd_sender_id").value);
	...
	$(document).ready(function(){
		...
		// 	params.append("TdrSearchSummary[admin_id]", $("#dd_admin_id").val());
		// 	params.append("TdrSearchSummary[sender_id]", $("#dd_sender_id").val());
		// 	params.append("TdrSearchSummary[delivered_time]", $("#dr_from_to_date").val());
		// 	window.location.replace(`${location.pathname}?${params.toString()}`);
		// }; 
                    ...
                    <div class="card-body">
                        ...
                        <div id="dropdown_top" style="margin-top:1em;">
                            <ul class="gv_top">
                                ...
                                <li>
                                    <?= Html::dropdownlist('dd_admin_id',  isset($_GET['TdrSearchSummary']['admin_id']) ?  $_GET['TdrSearchSummary']['admin_id'] : ""  , $clients, ['id' => 'dd_admin_id', 'class' => 'btn btn-dark btn-sm', 'prompt' => 'Select Client']); ?>
                                </li>
                                <li>
                                    <?= Html::dropdownlist('dd_sender_id',  isset($_GET['TdrSearchSummary']['sender_id']) ?  $_GET['TdrSearchSummary']['sender_id'] : ""  , $suppliers, ['id' => 'dd_sender_id', 'class' => 'btn btn-dark btn-sm', 'prompt' => 'Select Supplier']); ?>
                                </li>
                                <li>
