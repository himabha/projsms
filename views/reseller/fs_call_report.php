			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title ">Agent Detailed Report</h4>
					</div>
					<div class="card-body">
...
-->
						...
						<?= Html::beginForm(['reseller/fs-call-report'], 'get') ?>
						<div class="row">
							<div class="col-sm-3">
								<?php
							...
							$.ajax({
								url: baseurl + "?r=reseller/load-search-fields",
								type: "post",
								data: {start :start,end:end},
								success: function (response) {
									$("#agent").html(response.agent_optn);
