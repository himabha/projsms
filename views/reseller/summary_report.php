					...
					<div class="card-body">
						...
						<div id="dropdown_top" style="margin-top:1em;">
							<ul class="gv_top">
								...
								<li>
									<?= Html::dropdownlist('dd_agent_id',  isset($_GET['TdrSearchSummary']['agent_id']) ?  $_GET['TdrSearchSummary']['agent_id'] : "", $agents, ['id' => 'dd_agent_id', 'class' => 'btn btn-dark btn-sm', 'prompt' => 'Select Agent']); ?>
								</li>
								<li>
							...
							<?= GridView::widget([
								...
								'columns' => [
									...
									[
										...
										'attribute' => 'agent_id',
										'value' => function ($model) {
											return $model->users ? $model->users->username : null;
										}
									],
									[
										'attribute' => 'msgs',
