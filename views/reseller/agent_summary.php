			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header card-header-primary">
						<h4 class="card-title ">Agentwise Summary</h4>
					</div>
					<div class="card-body">
						...
						'footer' => '<strong>Total : &#162;'.Fscallreport::getTotalCharges($dataProvider->models).'</strong>',
									...
									[
										...
										'value' => 'cld2_cost',
										'footer' => '<strong>Page Total : ' . Fscallreport::getTotalAgentCost($dataProvider->models) . '</strong>',
									],
									/*[
						...
						'footer' => '<strong>Total : &#162;'.Fscallreport::getTotalMargin($dataProvider->models).'</strong>',
									...
									[
										...
										'value' => 'cld3_cost',
										'footer' => '<strong>Page Total : ' . Fscallreport::getTotalAgentSale($dataProvider->models) . '</strong>',
									],
								],
							]); ?>
						</div>
