    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?= Html::beginForm(['/reseller/allocate-numbers'], 'post', []) ?>
                <input type="hidden" name="hdnAllocateNumbers" id="hdnAllocateNumbers">
                <div style="margin-bottom:2em;">
                    <?= Html::dropDownList('cboClient', '', $clients_only, ['prompt' => 'Select Client', 'class' => 'form-select custom_select', 'required' => 'required']) ?>
                </div>
                <div class="media form-group">
