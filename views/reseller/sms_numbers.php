...
<div id="allocate_numbers" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="allocated_message" style="font-size:smaller; color:red; border:1px solid #ccc; padding:0.5em; margin-bottom:3em;">
				</div>
...
<div id="unallocate_numbers" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="unallocated_message" style="font-size:smaller; color:red; border:1px solid #ccc; padding:0.5em; margin-bottom:3em;">
				</div>
